...
int main() {
    ...
    for (const auto& img_path : image_paths) {
        ...
        ContourMetrics results = process_image(img_path.string(), background);
    ...
    if (processed_images > 0) {
        double average_time = total_time / processed_images;
        cout << "Average processing time: " << average_time << " seconds per image" << endl;
        cout << "Total images processed: " << processed_images << endl;
    }
