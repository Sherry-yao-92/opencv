...
int main() {
    ...
    string img_path = img_folder + "0001.tiff";
    ...
    cout << "Processing 0001.tiff:" << endl;
    ...
    if (!results.contour.empty()) {
        ...
        imshow("Original Contour - 0001.tiff", original_contour_image);
        imshow("Convex Hull - 0001.tiff", hull_contour_image);
        waitKey(0);
        destroyAllWindows();
    } else {
